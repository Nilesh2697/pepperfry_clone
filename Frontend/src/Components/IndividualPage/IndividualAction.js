...
import {
    ...
    ADD_TO_CART_REQUEST,
    ADD_TO_CART_SUCCESS,
    ADD_TO_LOCAL_CART_REQUEST,
    ADD_TO_LOCAL_CART_SUCCESS,
    ...
    FETCH_IN_WISHLIST_FAILURE,
    FETCH_IN_WISHLIST_REQUEST,
    FETCH_IN_WISHLIST_SUCCESS,
    FINAL_CART_SET_FAILURE,
    FINAL_CART_SET_REQUEST,
    FINAL_CART_SET_SUCCESS,
    FINAL_WISH_SET_SUCCESS,
    GET_DATA_BY_CATEGORY_FAILURE,
    GET_DATA_BY_CATEGORY_REQUEST,
...
export const getDataByCategory = (payload) => (dispatch) => {
    ...
    axios
        .get(`https://glacial-atoll-43442.herokuapp.com/${payload}`)
...
export const addToCart = (userId, payload) => (dispatch) => {
    ...
    if (userId !== "" || userId !== undefined || userId !== null) {
        ...
        axios
            .put(`https://glacial-atoll-43442.herokuapp.com/users/${userId}`, {
                cart: payload,
            })
...
export const fetchInWishList = (payload) => (dispatch) => {
    ...
    axios
        .get(`https://glacial-atoll-43442.herokuapp.com/userbyID/${payload}`)
