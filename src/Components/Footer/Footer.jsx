...
const main_footer =   [
    ...
    ['About Us', 'Our Blog', 'Careers', 'Corporate Governance', 'Pepperfry In The News','Find A Studio', 'Gift Cards', 'Brands', 'Customer Reviews' ],
    
]
const footer_list = [
        [
            'PARTNERS',
            ['Partner With Us', 'Pepperfry Market Policies', 'Login To Your Merchant Dashboard', "Important: ","GST and You", 'Corporate Enquiries']
        ], 
